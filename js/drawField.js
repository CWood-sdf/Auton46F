function drawField() {
  ...
  //   p.rect(
  //     pos.x * height,
  //     pos.y * height + blackWidth,
  //     rollerHeight,
  //     rollerWidth,
  //   );
  //   p.fill(RED);
  //   p.rect(
  //     pos.x * height + rollerHeight,
  //     pos.y * height + blackWidth,
  //     rollerHeight,
  //     rollerWidth,
  //   );
  ...
  //   p.rect(
  //     pos.x * height,
  //     pos.y * height + rollerWidth + blackWidth,
  //     rollerHeight * 2,
  //     blackWidth,
  //   );
  //   //Top right
  ...
  //   p.fill(BLUE);
  //   p.rect(
  //     pos.x * height + blackWidth,
  //     pos.y * height + rollerHeight,
  //     rollerWidth,
  //     rollerHeight,
  //   );
  //   p.fill(RED);
  ...
  //   p.rect(
  //     pos.x * height + rollerWidth + blackWidth,
  //     pos.y * height,
  //     blackWidth,
  //     rollerHeight * 2,
  //   );
  ...
  //   p.fill(BLUE);
  //   p.rect(
  //     pos.x * height - rollerHeight * 2,
  //     pos.y * height - blackWidth - rollerWidth,
  //     rollerHeight,
  //     rollerWidth,
  //   );
  //   p.fill(RED);
  ...
  //   p.rect(
  //     pos.x * height - rollerHeight * 2,
  //     pos.y * height - blackWidth * 2 - rollerWidth,
  //     rollerHeight * 2,
  //     blackWidth,
  //   );
  //   p.rect(
  ...
  //   p.fill(BLUE);
  //   p.rect(
  //     pos.x * height - blackWidth - rollerWidth,
  //     pos.y * height - rollerHeight,
  //     rollerWidth,
  //     rollerHeight,
  //   );
  ...
  //   p.rect(
  //     pos.x * height - blackWidth,
  //     pos.y * height - rollerHeight * 2,
  //     blackWidth,
  //     rollerHeight * 2,
  //   );
  //   p.rect(
  //     pos.x * height - rollerWidth - 2 * blackWidth,
  //     pos.y * height - rollerHeight * 2,
  //     blackWidth,
  //     rollerHeight * 2,
  //   );
  ...
  //Plot points
  {
    ...
    if (selectedPlotButtonIndex !== -1) {
      ...
      p.text(
        "X: " +
          (fieldPos.x * 24 - 72).toFixed(2) +
          " Y: " +
          (-fieldPos.y * 24 + 72).toFixed(2),
        1 * height,
        75 * height,
      );
    }
    ...
    for (const pt of plotPoints) {
      ...
      if (
        (allowObjectsMove || allowPlotPointsMove) &&
        !goalBtns.reduce(
          (prev, val) => prev || val.pressing || val.pressed,
          false,
        )
      ) {
        pt.handlePress();
